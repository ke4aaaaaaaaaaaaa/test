...
var _getStorage = _interopRequireDefault(__webpack_require__(39));
...
var _createWebStorage = _interopRequireDefault(__webpack_require__(316));
...
;// CONCATENATED MODULE: ./components/message-list/message/message.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const message_module = ({"message__box":"_22igi5AjCc2xLUX_nTCSyo","message__text":"_3SfbMso2kHY2VS_eFUXDEF","message__user":"_2m0iTvwFIrhtfmcovoU6OC","message__time":"_170oc7Ekdmy93Sf44aQOmB"});
;// CONCATENATED MODULE: ./components/message-list/message/message.jsx
...
var Message = function Message(props) {
  ...
  return /*#__PURE__*/react.createElement("li", {
    className: classnames_default()(message_module.message__box, "message__box--".concat(author !== "Robot" ? "user" : "robot"))
  }, /*#__PURE__*/react.createElement("p", {
    className: message_module.message__text
  }, message), /*#__PURE__*/react.createElement("p", {
    className: message_module.message__time
  }, date), /*#__PURE__*/react.createElement("h5", {
    className: message_module.message__user
  }, author));
};
Message.propTypes = {
...
;// CONCATENATED MODULE: ./components/message-list/message/index.js
...
var TextareaAutosize = /*#__PURE__*/react.forwardRef(function TextareaAutosize(props, ref) {
  var onChange = props.onChange,
      ...
      style = props.style,
      value = props.value,
      other = objectWithoutProperties_objectWithoutProperties(props, ["onChange", "rows", "rowsMax", "rowsMin", "style", "value"]);
...
;// CONCATENATED MODULE: ../node_modules/@material-ui/icons/esm/Send.js


/* harmony default export */ const Send = (createSvgIcon( /*#__PURE__*/react.createElement("path", {
...
;// CONCATENATED MODULE: ./api/logger.js
var withLogger = function withLogger(axios) {
  axios.interceptors.request.use(function (request) {
    console.log("%c AXIOS [request] ".concat(request.url, ":"), "color: #008000; font-weight: bold", request);
    return request;
  }, function (error) {
  ...
  axios.interceptors.response.use(function (config) {
    console.log("%c AXIOS [response-success] ".concat(config.config.url, ":"), "color: #008000; font-weight: bold", config);
    return config;
  }, function (error) {
...
var Request = function Request(token) {
  var _this = this;

  _classCallCheck(this, Request);

  _defineProperty(this, "requestWithToken", function () {
    return {
      header: {
        "x-token": _this.token
      }
  ...
  _defineProperty(this, "get", function (url, withAuth) {
    var config = {};

    if (withAuth) {
      config = _objectSpread(_objectSpread({}, config), _this.requestWithToken());
    }

    return _this.request.get(url, config);
  });
  ...
  _defineProperty(this, "post", function (url, params) {
    ...
    return _this.request.post(url, params, config);
  });

  this.token = token;
  this.request = withLogger(axios_default().create({
    baseURL: "http://localhost:3000/",
    timeout: 10000
  }));
};

var request = new Request("test token");
;// CONCATENATED MODULE: ./api/index.js


;// CONCATENATED MODULE: ./store/middleware/logger.js
...
;// CONCATENATED MODULE: ./store/messages/type.js
var SEND_MESSAGES = "@messages/send";
;// CONCATENATED MODULE: ./store/middleware/robotResponse.js


var setTimeoutOn = true;
var robotResponse = function robotResponse(store) {
  return function (next) {
    return function (action) {
      if (action.type === SEND_MESSAGES && action.payload.newMessage.author !== "Robot" && setTimeoutOn) {
        setTimeoutOn = !setTimeoutOn;
        setTimeout(function () {
          store.dispatch(sendMessages(action.payload.roomId, {
            author: "Robot",
            message: "\u0417\u0434\u0440\u0430\u0432\u0441\u0442\u0432\u0443\u0439\u0442\u0435 ".concat(action.payload.newMessage.author, "!  \u042F \u0440\u043E\u0431\u043E\u0442 \u043A\u043E\u043C\u043D\u0430\u0442\u044B #").concat(action.payload.roomId, ",  \u043D\u0435 \u043E\u0442\u0432\u0435\u0447\u0430\u0439\u0442\u0435 \u043C\u043D\u0435."),
...
;// CONCATENATED MODULE: ./store/middleware/index.js
...
function persistReducer_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = persistReducer_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function persistReducer_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var storage = __webpack_require__(494);
...
;// CONCATENATED MODULE: ./store/conversations/type.js
var RESET_VALUE_CONVERSATIONS = "@conversations/resetValue";
var CHANGE_VALUE_CONVERSATIONS = "@conversations/changeValue";
var ADD_ROOM_CONVERSATIONS = "@conversations/addRoom";
;// CONCATENATED MODULE: ./store/conversations/actions.js

var resetValueConversations = function resetValueConversations(roomId) {
  return {
    type: RESET_VALUE_CONVERSATIONS,
    payload: roomId
  };
};
var changeValueConversations = function changeValueConversations(roomId, value) {
  return {
...
var addRoomConversations = function addRoomConversations(nameRoom) {
  return {
    type: ADD_ROOM_CONVERSATIONS,
    payload: nameRoom
  };
};
;// CONCATENATED MODULE: ./store/conversations/reducer.js
...
var conversationsReducer = createReducer(reducer_initialState, (_createReducer = {}, _defineProperty(_createReducer, RESET_VALUE_CONVERSATIONS, function (state, action) {
  return state.map(function (conversation) {
    if (action.payload === conversation.title) {
      return reducer_objectSpread(reducer_objectSpread({}, conversation), {}, {
        value: ""
      });
    }
...
}), _defineProperty(_createReducer, CHANGE_VALUE_CONVERSATIONS, function (state, action) {
  return state.map(function (conversation) {
...
}), _defineProperty(_createReducer, ADD_ROOM_CONVERSATIONS, function (state, action) {
  return [].concat(toConsumableArray_toConsumableArray(state), [{
...
*/
;// CONCATENATED MODULE: ./store/conversations/selector.js
var getChatList = function getChatList() {
  return function (state) {
    return state.conversationsReducer;
  };
};
var getChatValue = function getChatValue(roomId) {
  return function (state) {
    var _state$conversationsR;

    return ((_state$conversationsR = state.conversationsReducer.find(function (conversation) {
      return conversation.title === roomId;
    })) === null || _state$conversationsR === void 0 ? void 0 : _state$conversationsR.value) || "";
  };
};
;// CONCATENATED MODULE: ./store/conversations/index.js



;// CONCATENATED MODULE: ./store/gists/type.js
var GET_GISTS_START = "gists@GET_GISTS_REQUEST";
var GET_GISTS_SUCCESS = "gists@GET_GISTS_SUCCESS";
var GET_GISTS_FAILURE = "gists@GET_GISTS_FAILURE";
var GET_GISTS_CHANGE_VALUE = "gists@GET_GISTS_CHANGE_VALUE";
;// CONCATENATED MODULE: ./store/gists/action.js

var action_getGistsRequest = function getGistsRequest() {
  return {
    type: GET_GISTS_START
  };
};
var action_getGistsSuccess = function getGistsSuccess(data) {
  return {
    type: GET_GISTS_SUCCESS,
    payload: data
  };
};
var action_getGistsFailure = function getGistsFailure(error) {
  return {
    type: GET_GISTS_FAILURE,
    payload: error
  };
};
var getGistsSendValue = function getGistsSendValue(value) {
  return {
    type: GET_GISTS_CHANGE_VALUE,
    payload: value
  };
};
;// CONCATENATED MODULE: ./store/gists/reducer.js


function gists_reducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function gists_reducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { gists_reducer_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { gists_reducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }


var gists_reducer_initialState = {
  gists: [],
  error: null,
  pending: false,
  value: ""
};
var gistsReducer = function gistsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : gists_reducer_initialState;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case GET_GISTS_START:
      return gists_reducer_objectSpread(gists_reducer_objectSpread({}, state), {}, {
        pending: true
      });
...
;// CONCATENATED MODULE: ./store/gists/selector.js
var getGists = function getGists() {
  return function (state) {
    return state.gistsReducer;
  };
};
...
;// CONCATENATED MODULE: ./store/gists/thunks.js



var API_URL_PUBLIC = "https://api.pandascore.co/tournaments/upcoming?token=G3c07FxOzSESI6vO96uIEUBeOInSEF_bkWGvT1t-e7TD_BZ1G3k";

var API_URL_SEARCH_GIST = function API_URL_SEARCH_GIST(name) {
  return "https://api.github.com/users/".concat(name, "/gists");
};

var getAllGists = function getAllGists() {
  return /*#__PURE__*/function () {
    var _ref = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(dispatch) {
      var res, result;
      return regenerator_default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              dispatch(action_getGistsRequest());
              _context.prev = 1;
              _context.next = 4;
              return fetch(API_URL_PUBLIC);
            ...
            case 9:
              ...
              console.log(res);
              dispatch(action_getGistsSuccess(result));
              _context.next = 17;
              break;
            ...
            case 14:
              ...
              dispatch(action_getGistsFailure(_context.t0.message));
...
var getAllGistsByUserName = function getAllGistsByUserName(value, ref) {
  return /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(dispatch, _, request) {
      var isCurrentQuery, res;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              isCurrentQuery = value === ref;
              _context2.prev = 3;
              _context2.next = 6;
              return request.get(API_URL_SEARCH_GIST(value));
            ...
            case 10:
              ...
              if (_context2.t0.data.message === "Not Found") {
                dispatch(getGistsFailure("Такого юзера нет"));
              } else {
                dispatch(getGistsFailure(_context2.t0.data.message));
              }
...
;// CONCATENATED MODULE: ./store/gists/index.js




;// CONCATENATED MODULE: ./store/messages/actions.js

var sendMessages = function sendMessages(roomId, newMessage) {
  return {
    type: SEND_MESSAGES,
    payload: {
      roomId: roomId,
...
;// CONCATENATED MODULE: ./store/messages/reducer.js



function messages_reducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function messages_reducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { messages_reducer_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { messages_reducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }


var messages_reducer_initialState = {
  aaJa: [{
    author: "Ke4a",
    message: "Привет !",
    date: new Date().toLocaleString()
  ...
  bF12: [{
    author: "Ke4a",
    message: "Привет room2!",
    date: new Date().toLocaleString()
  }]
};

var reducer_createReducer = function createReducer(initialState, handlers) {
  return function reducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
    var action = arguments.length > 1 ? arguments[1] : undefined;
...
var messagesReducer = reducer_createReducer(messages_reducer_initialState, _defineProperty({}, SEND_MESSAGES, function (state, action) {
  return messages_reducer_objectSpread(messages_reducer_objectSpread({}, state), {}, _defineProperty({}, action.payload.roomId, [].concat(toConsumableArray_toConsumableArray(state[action.payload.roomId] || []), [action.payload.newMessage])));
}));
...
;// CONCATENATED MODULE: ./store/messages/selector.js
var getMessageList = function getMessageList() {
  return function (state) {
    return state.messagesReducer;
  };
};
;// CONCATENATED MODULE: ./store/messages/index.js



;// CONCATENATED MODULE: ./store/profile/types.js
var TOGGLE_PROFILE_CHECKBOX = "@profile/toggle checkbox";
var UPDATE_USER_NAME = "@profile/update user name";
var INPUT_PROFILE = "@profile/input";
;// CONCATENATED MODULE: ./store/profile/actions.js

var toggleCheckBox = function toggleCheckBox() {
  return {
    type: TOGGLE_PROFILE_CHECKBOX
  };
};
var handleChangInput = function handleChangInput(value) {
  return {
    type: INPUT_PROFILE,
    payload: value
  };
...
;// CONCATENATED MODULE: ./store/profile/reducer.js


var profile_reducer_createReducer;

function profile_reducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function profile_reducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { profile_reducer_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { profile_reducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }


var profile_reducer_initialState = {
  value: "",
  isToggle: false,
  name: "Ke4a"
};

var store_profile_reducer_createReducer = function createReducer(initialState, handlers) {
  return function reducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
    var action = arguments.length > 1 ? arguments[1] : undefined;
...
var profileReducer = store_profile_reducer_createReducer(profile_reducer_initialState, (profile_reducer_createReducer = {}, _defineProperty(profile_reducer_createReducer, INPUT_PROFILE, function (state, actions) {
  return profile_reducer_objectSpread(profile_reducer_objectSpread({}, state), {}, {
    value: actions.payload
  });
}), _defineProperty(profile_reducer_createReducer, TOGGLE_PROFILE_CHECKBOX, function (state) {
  return profile_reducer_objectSpread(profile_reducer_objectSpread({}, state), {}, {
    isToggle: !state.isToggle
  });
}), _defineProperty(profile_reducer_createReducer, UPDATE_USER_NAME, function (state) {
  return profile_reducer_objectSpread(profile_reducer_objectSpread({}, state), {}, {
    name: state.value
  });
}), profile_reducer_createReducer));
;// CONCATENATED MODULE: ./store/profile/selector.js
var getProfile = function getProfile() {
  return function (state) {
    return state.profileReducer;
  };
};
;// CONCATENATED MODULE: ./store/profile/index.js



;// CONCATENATED MODULE: ./store/create-store.js
...
var persistReducers = persistReducer({
  key: "root",
  ...
  gistsReducer: gistsReducer,
  profileReducer: profileReducer
}));
var store = createStore(persistReducers, compose(applyMiddleware(es.withExtraArgument(request), logger, robotResponse), window.__REDUX_DEVTOOLS_EXTENSION__ ? window.__REDUX_DEVTOOLS_EXTENSION__() : function (args) {
  return args;
}));
...
var path_to_regexp = __webpack_require__(933);
...
;// CONCATENATED MODULE: ./components/message-list/message-list.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const message_list_module = ({"messagesListBox":"kznnNm9YaSOgN24u9UAH7","icon":"_3gpdveRUwDui64qMZPqdrq","messagesList":"_2prbEJXW-mtseQADYfQdZu","noMessage":"_7qDhebPrfZ-dV78kbpkvo"});
;// CONCATENATED MODULE: ./components/message-list/message-list.jsx
...
var StyledInput = styles_withStyles(function () {
  return {
    root: {
      "&": {
        padding: "5px",
...
var MessageList = function MessageList() {
  var memoSelectorMessageList = (0,react.useMemo)(function () {
    return getMessageList();
  }, []);
  var MessageList = useSelector(memoSelectorMessageList);
  var userNameSelector = (0,react.useMemo)(function () {
    return getProfile();
  }, []);

  var _useSelector = useSelector(userNameSelector),
      name = _useSelector.name;

  var _useParams = useParams(),
      roomId = _useParams.roomId;

  var messages = MessageList[roomId] || [];
  var dispatch = useDispatch();
  var sendMessage = (0,react.useCallback)(function (_ref) {
    var _ref$author = _ref.author,
        author = _ref$author === void 0 ? name : _ref$author,
  ...
  var memoSelectorValue = (0,react.useMemo)(function () {
    return getChatValue(roomId);
  }, [roomId]);
  var value = useSelector(memoSelectorValue);
  var onKeyPressHandler = react.useCallback(function (_ref2) {
    var code = _ref2.code;
  ...
  var handleChangeValue = (0,react.useCallback)(function (event) {
    var value = event.target.value;
    dispatch(changeValueConversations(roomId, value));
  }, [dispatch, roomId]);
  var InputButton = react.useCallback(function () {
    return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(StyledInput, {
      autoFocus: true,
      ...
      endAdornment: /*#__PURE__*/react.createElement(InputAdornment_InputAdornment, {
        position: "end"
      }, value && /*#__PURE__*/react.createElement(Send, {
        className: message_list_module.icon,
        type: "button",
  ...
  if (MessageList[roomId]) {
    return /*#__PURE__*/react.createElement("div", {
      className: message_list_module.messagesListBox
    }, /*#__PURE__*/react.createElement("ul", {
      className: message_list_module.messagesList
    }, messages.map(function (message, index) {
      return /*#__PURE__*/react.createElement(Message, {
        messages: message,
        key: index
      });
    })), /*#__PURE__*/react.createElement(InputButton, null));
  } else {
    return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
      className: message_list_module.messagesListBox
    }, /*#__PURE__*/react.createElement("h3", {
      className: message_list_module.noMessage
    }, "No message"), /*#__PURE__*/react.createElement(InputButton, null)));
  }
};
;// CONCATENATED MODULE: ./components/message-list/index.js

;// CONCATENATED MODULE: ./components/layout/layout.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const layout_module = ({"messenger":"_9Q_lH1j_6M0ZnteVnHS-b"});
...
var Layout = function Layout(props) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, header, /*#__PURE__*/react.createElement("div", {
    className: layout_module.messenger
  }, chatList, messageList));
};
Layout.propTypes = {
  chatList: (prop_types_default()).object,
  messageList: (prop_types_default()).object,
  header: (prop_types_default()).object
};
...
var ListItem = /*#__PURE__*/react.forwardRef(function ListItem(props, ref) {
  ...
  var ContainerClassName = _props$ContainerProps.className,
      ContainerProps = objectWithoutProperties_objectWithoutProperties(_props$ContainerProps, ["className"]),
      ...
      other = objectWithoutProperties_objectWithoutProperties(props, ["alignItems", "autoFocus", "button", "children", "classes", "className", "component", "ContainerComponent", "ContainerProps", "dense", "disabled", "disableGutters", "divider", "focusVisibleClassName", "selected"]);
  ...
  if (hasSecondaryAction) {
    ...
    return /*#__PURE__*/react.createElement(List_ListContext.Provider, {
      value: childContext
    }, /*#__PURE__*/react.createElement(ContainerComponent, extends_extends({
...
var ListItemText = /*#__PURE__*/react.forwardRef(function ListItemText(props, ref) {
  var children = props.children,
      ...
      other = objectWithoutProperties_objectWithoutProperties(props, ["children", "classes", "className", "disableTypography", "inset", "primary", "primaryTypographyProps", "secondary", "secondaryTypographyProps"]);
  ...
  if (primary != null && primary.type !== Typography_Typography && !disableTypography) {
    primary = /*#__PURE__*/react.createElement(Typography_Typography, extends_extends({
  ...
  if (secondary != null && secondary.type !== Typography_Typography && !disableTypography) {
    secondary = /*#__PURE__*/react.createElement(Typography_Typography, extends_extends({
      variant: "body2",
...
;// CONCATENATED MODULE: ./components/chat-list/chat/chat.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const chat_module = ({"link":"_1Xou64Np3Q7Z4Td5aNtTIP","nameRoomDiv":"A6-z92hv0f64PX1dWzbgp"});
;// CONCATENATED MODULE: ./components/chat-list/chat/chat.jsx
...
var StyledListItem = styles_withStyles(function () {
  return {
    root: {
      "&": {
...
var StyledListItemTextAuthor = styles_withStyles(function () {
  return {
    primary: {
      "&": {
        fontSize: "15px",
...
var StyledListItemTextMessage = styles_withStyles(function () {
  return {
    primary: {
      "&": {
        fontSize: "15px",
...
var Chat = function Chat(props) {
  ...
  var room = "Room #".concat(title);

  if (messageList[title] !== undefined) {
    var _messageList$title2;

    var _messageList$title = messageList[title][((_messageList$title2 = messageList[title]) === null || _messageList$title2 === void 0 ? void 0 : _messageList$title2.length) - 1],
        author = _messageList$title.author,
        message = _messageList$title.message;
    return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Link, {
      className: chat_module.link,
      to: "/chat/" + title
    }, /*#__PURE__*/react.createElement(StyledListItem, {
      button: true,
      href: "#",
      selected: roomId === title
    }, /*#__PURE__*/react.createElement("div", {
      className: chat_module.nameRoomDiv
    }, /*#__PURE__*/react.createElement(StyledListItemTextAuthor, {
      primary: room
    }), /*#__PURE__*/react.createElement(StyledListItemTextAuthor, {
      primary: author
    })), /*#__PURE__*/react.createElement(StyledListItemTextMessage, {
      primary: message
    }))));
  }
...
;// CONCATENATED MODULE: ./components/chat-list/chat/index.js
...
;// CONCATENATED MODULE: ./components/chat-list/chat-list.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const chat_list_module = ({"chat_list":"ssytFu-4IQXv6h5t-vZj9","chat_list__button":"_3kJGtLtFBrhORPd8UzLGsZ"});
;// CONCATENATED MODULE: ./components/chat-list/chat-list.jsx
...
var ChatList = function ChatList() {
  var memoSelector = (0,react.useMemo)(function () {
    return getChatList();
  }, []);
  var chatList = useSelector(memoSelector);
  var dispatch = useDispatch();

  var addRoom = function addRoom() {
    var nameRoom = nanoid(4);

    if (chatList.map(function (chat) {
      return chat.title !== nameRoom;
    })) {
  ...
  return /*#__PURE__*/react.createElement(List_List, {
    "aria-label": "contacts",
    className: chat_list_module.chat_list,
    disablePadding: true
  }, /*#__PURE__*/react.createElement("button", {
    className: chat_list_module.chat_list__button,
    onClick: addRoom
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u041A\u043E\u043C\u043D\u0430\u0442\u0443"), chatList.map(function (conversation, index) {
...
;// CONCATENATED MODULE: ./components/chat-list/index.js

;// CONCATENATED MODULE: ./components/header/header.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const header_module = ({"header":"_1sSW8ohZBquuklwmfeKOHd","header_box":"_1vfe6Wpn2FnIs8v4W9HsWS","text":"epIDlchqkjzn53QwGWQCp","link":"_1DL2DfWm6eNN5Wpm1XOXGR"});
...
var Header = function Header() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("header", {
    ...
    className: header_module.header_box
    ...
    className: header_module.link,
    to: "/gists"
  }, "Gists")), /*#__PURE__*/react.createElement("h3", {
    className: header_module.text
  }, "room #", roomId)));
};
...
var Profile = function Profile(props) {
  var _useSelector = useSelector(getProfile()),
      value = _useSelector.value,
      isToggle = _useSelector.isToggle,
      name = _useSelector.name;

  var header = props.header;
  var dispatch = useDispatch();
  return /*#__PURE__*/react.createElement(react.Fragment, null, header, /*#__PURE__*/react.createElement("label", {
    htmlFor: "checkBox"
  }, "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0418\u043C\u044F"), /*#__PURE__*/react.createElement("input", {
    id: "checkBox",
    type: "checkbox",
    checked: isToggle,
    onChange: function onChange() {
      return dispatch(toggleCheckBox());
    }
  }), /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement("input", {
    value: value,
    onChange: function onChange(event) {
      return dispatch(handleChangInput(event.target.value));
    },
    placeholder: "Введите имя"
  }), value && /*#__PURE__*/react.createElement("button", {
    onClick: function onClick() {
      return dispatch(updateUserName());
    }
  }, "Update Name"), isToggle && /*#__PURE__*/react.createElement("h1", null, name));
};
Profile.propTypes = {
  header: (prop_types_default()).object
};
...
;// CONCATENATED MODULE: ./components/gists/gists.jsx





var Gists = function Gists(props) {
  var header = props.header;

  var _useSelector = useSelector(getGists()),
      gists = _useSelector.gists,
      error = _useSelector.error,
      pending = _useSelector.pending,
      value = _useSelector.value;

  var dispatch = useDispatch();
  var ref = (0,react.useRef)("");
  var handleChangeValue = lodash_debounce_default()(function (value) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, header, /*#__PURE__*/react.createElement("h1", null, "Gists"), /*#__PURE__*/react.createElement("input", {
    placeholder: "Search...",
    onChange: function onChange(e) {
      return handleChangeValue(e.target.value);
    },
    type: "text"
  }), error && /*#__PURE__*/react.createElement("h1", null, error), pending && !error ? /*#__PURE__*/react.createElement("h3", null, "\u041E\u0431\u0440\u0430\u0431\u0430\u0442\u044B\u0432\u0430\u0435\u0442\u0441\u044F fetch") : /*#__PURE__*/react.createElement("ul", null, gists === null || gists === void 0 ? void 0 : gists.map(function (item, index) {
    return /*#__PURE__*/react.createElement("li", {
      key: index
...
;// CONCATENATED MODULE: ./components/gists/index.js
...
var chat_Chat = function Chat() {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Switch, null, /*#__PURE__*/react.createElement(Route, {
    ...
    path: "/gists"
  }, /*#__PURE__*/react.createElement(Gists, {
    header: /*#__PURE__*/react.createElement(Header, null)
  })), /*#__PURE__*/react.createElement(Route, {
    path: ["/chat/:roomId", "/chat", "/"]
  }, /*#__PURE__*/react.createElement(Layout, {
    messageList: /*#__PURE__*/react.createElement(MessageList, null),
    chatList: /*#__PURE__*/react.createElement(ChatList, null),
    header: /*#__PURE__*/react.createElement(Header, null)
  }))));
};
...
function _possibleConstructorReturn(self, call) { if (call && (react_typeof(call) === "object" || typeof call === "function")) { return call; } return react_assertThisInitialized(self); }
...
var App = function App() {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(chat_Chat, null));
};

react_dom.render( /*#__PURE__*/react.createElement(HashRouter, {
  basename: process.env.PUBLIC_URL
}, /*#__PURE__*/react.createElement(components_Provider, {
  store: store
